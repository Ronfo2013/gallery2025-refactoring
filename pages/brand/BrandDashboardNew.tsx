    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center slide-up">
          ...
          <h2 className="heading-md text-gray-900 mb-2">Authentication Required</h2>
          <p className="text-muted mb-6">Please login to access the dashboard.</p>
          <Button
            variant="primary"
            size="lg"
...
const BrandDashboardNew: React.FC = () => {
  const { user, isAuthenticated, logout, isLoading: authLoading } = useFirebaseAuth();
