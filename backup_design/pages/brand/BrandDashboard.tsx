          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Button
                ...
                onClick={() =>
                  window.open(`https://www.clubgallery.com/${brand.slug}`, '_blank')
                }
              >
                View Gallery
              </Button>
...
const BrandDashboardNew: React.FC = () => {
  ...
  if (!isAuthenticated || !user) {
    return (
      <GlassAuthLayout
        title="Brand Dashboard Access"
        subtitle="Inserisci le credenziali per gestire album, branding e impostazioni."
      >
