 ...
 */
exports.createCheckoutSession = functions.region('us-west1').https.onCall(async (data, context) => {
  ...
  // Validate inputs
  if (!email || !brandName) {
    throw new functions.https.HttpsError('invalid-argument', 'Email and brand name are required');
  }
